/**
 * PreSales Quiz Application Logic
 * No Frameworks, Pure JS.
 */

// --- Data: 100 Quiz (First 25 questions from provided text) ---
const quizData100 = [
    {
        q: "프리세일즈의 핵심 역할은?",
        a: [
            "기능 요구사항만 전달하는 역할",
            "기술 문제만 해결하는 역할",
            "고객 의사결정을 돕는 기술·비즈니스 조율 역할",
            "계약 이후 운영을 담당하는 역할"
        ],
        correct: 2 // Index 2 is the 3rd option
    },
    {
        q: "‘기술 대표’라는 표현의 의미는?",
        a: [
            "제품 로드맵을 결정하는 사람",
            "사내 기술 총괄 책임자",
            "고객의 기술적 신뢰 형성을 주도하는 역할",
            "기술 문서를 관리하는 역할"
        ],
        correct: 2
    },
    {
        q: "프리세일즈 수요가 증가한 핵심 이유는?",
        a: [
            "영업 인력이 줄어서",
            "기술 문서가 늘어서",
            "기술 환경이 복잡해져 고객이 해석 도움을 필요로 해서",
            "SaaS 가격이 높아져서"
        ],
        correct: 2
    },
    {
        q: "HBR 분석이 의미하는 핵심 포인트는?",
        a: [
            "문서 품질 향상",
            "프리세일즈 교육 증가",
            "기술 활동이 매출 지표에 직접 영향을 준다는 점",
            "개발 속도 개선"
        ],
        correct: 2
    },
    {
        q: "프리세일즈 온보딩에 시간이 걸리는 이유는?",
        a: [
            "문서 작업 때문에",
            "사내 절차가 복잡해서",
            "산업·제품·경쟁 구도를 모두 이해해야 해서",
            "실습 시간이 많아서"
        ],
        correct: 2
    },
    ...
    {
        q: "사후 조직과 역할이 겹치는 이유는?",
        a: [
            "개발팀이 부족해서",
            "고객 미팅이 많아서",
            "구매 여정 후반부까지 신뢰 연결이 필요해서",
            "조직 구조가 단순해서"
        ],
        correct: 2
    },
    {
        ...
        a: [
            "역할이 매우 제한적이다",
            "계약 이후는 참여하지 않는다",
            "제품 개선부터 기술 대응까지 영역이 넓다",
            "고객 미팅이 거의 없다"
        ],
        correct: 2
    },
    {
        q: "프리세일즈의 영향도가 중요한 이유는?",
        a: [
            "문서를 많이 써서",
            "가격 협상에 참여해서",
            "기술적 판단이 구매 결정에 영향을 주기 때문에",
            "팀장이 참여해서"
        ],
        correct: 2
    },
    {
        q: "프리세일즈가 기술 + 판매 역할을 하는 이유는?",
        a: [
            "기능을 많이 알아서",
            "코드를 수정할 수 있어서",
            "기술 기반 설득력이 구매 결정에 작용하기 때문에",
            "영업 인원이 적어서"
        ],
        correct: 2
    },
    {
        q: "전문성과 커뮤니케이션이 동시에 중요한 이유는?",
        a: [
            "문서를 많이 작성하기 때문",
            "영업과 협업이 많아서",
            "기술 내용을 고객 맞춤 형태로 전달해야 해서",
            "개발팀을 대신해야 해서"
        ],
        correct: 2
    },
    {
        q: "SPIN이 초기 미팅에 적합한 이유는?",
        a: [
            "기능 설명에 좋다",
            "가격 논의에 좋다",
            "고객의 문제 인식을 확장시키기 좋다",
    ...
    {
        q: "피라미드 구조가 고위층에 적합한 이유는?",
        a: [
            "화려해서",
            "데이터가 많아서",
            "결론 중심으로 빠르게 판단할 수 있어서",
            "작성이 간단해서"
        ],
        correct: 2
    },
    {
        q: "기술 회의에서 가장 어려운 단계는?",
        a: [
            "상황 설명",
            "문제 제기",
            "해결책 제시",
    ...
    {
        q: "프리세일즈가 ‘해석자’로 불리는 이유는?",
        a: [
            "용어를 많이 알고 있어서",
            "데이터를 직접 분석해서",
            "고객 맥락에 맞춘 설명이 필요하기 때문에",
            "개발팀을 대신하기 때문에"
        ],
        correct: 2
    },
    {
        q: "BANT에서 판단이 가장 어려운 요소는?",
        a: [
            "예산",
            "의사결정권",
            "필요성",
...
// --- Data: 200 Quiz (Remaining 25 questions) ---
const quizData200 = [
    {
        q: "솔루션 맵의 전략적 가치는?",
        a: [
            "문서를 보기 좋게 한다",
            "제품 설명 시간을 줄인다",
            "경쟁 구도를 기반으로 전략을 짤 수 있다",
            "가격표를 만들 수 있다"
        ],
        correct: 2
    },
    {
        q: "MEDDPICC 중 프리세일즈 기여도가 높은 영역은?",
        a: [
            "계약 절차",
            "가격 산정",
            "Pain과 기준 정의",
    ...
    {
        q: "고객 여정과 정렬해야 하는 이유는?",
        a: [
            "회사 규정 때문",
            "영업이 요구해서",
            "구매는 단계별 경험에 의해 크게 좌우되기 때문",
            "문서 형식 때문"
        ],
        correct: 2
    },
    {
        q: "제안서가 고객 혜택 중심이어야 하는 이유는?",
        a: [
            "장표가 줄어서",
            "기술 설명이 어려워서",
            "고객은 ‘자신이 얻는 변화’를 기준으로 판단하기 때문",
            "경쟁사가 그렇게 해서"
        ],
        correct: 2
    },
    ...
    },
    {
        ...
        a: [
            "시간을 맞추기 위해",
            "반복을 위해",
            "핵심 메시지를 다시 구조화해 각인시키기 위해",
            "문서를 늘리기 위해"
        ],
        correct: 2
    },
    {
        q: "PoC 기준 명확화가 중요한 이유는?",
        a: [
            "문서를 줄이려고",
            "일정 관리를 위해",
            "기술 승리 전략을 세우려면 필요하기 때문",
            "팀장이 원해서"
        ],
        correct: 2
    },
    {
        q: "고객이 “우리 문제는 단순하다”라고 말할 때 해석은?",
        a: [
            "그대로 믿는다",
            "기능 설명을 먼저 한다",
            "문제 이면의 복잡성을 점검한다",
    ...
    {
        q: "고객 시나리오 데모가 중요한 이유는?",
        a: [
            "화면이 예뻐서",
            "기능을 많이 보여줄 수 있어서",
            "고객이 자신의 상황에서 가치 판단을 하기 때문",
            "장표 수를 줄일 수 있어서"
        ],
        correct: 2
    },
    {
        q: "STAR에서 면접자가 강조해야 하는 부분은?",
        a: [
            "상황",
            "과제",
            "행동 + 결과",
    ...
    },
    {
        ...
        a: [
            "채용 정보 때문",
            "이벤트 참여 때문",
            "선배 프리세일즈의 사고 방식을 빠르게 흡수할 수 있어서",
            "회사 홍보 때문"
        ],
        correct: 2
    },
    {
        q: "전환 시 가장 어려운 “언어” 변화는?",
        a: [
            "UI 용어",
            "코딩 용어",
            "기술 중심에서 가치 중심으로의 전환",
    ...
    {
        q: "AI 시대에 프리세일즈의 역할이 강화되는 이유는?",
        a: [
            "문서 작성이 줄어서",
            "영업 인력이 줄어서",
            "고객은 ‘해석’과 ‘맥락화’가 필요하기 때문",
            "시스템이 복잡해져서"
        ],
        correct: 2
    },
    {
        q: "AI가 있어도 프리세일즈가 필요한 이유는?",
        a: [
            "AI가 데모를 못 해서",
            "구매에는 신뢰·관계·설득이 필요해서",
            "PoC가 늘어서",
    ...
    {
        q: "“제품만 좋으면 팔린다”가 위험한 이유는?",
        a: [
            "경쟁사 때문",
            "기능 격차가 줄어서",
            "구매는 관계·리스크·선택 비용이 포함된 의사결정이기 때문",
            "UI가 중요해서"
        ],
        correct: 2
    },
    {
        q: "AI 시대 프리세일즈가 가져야 할 조합은?",
        a: [
            "개발 + 디자인",
            "마케팅 + 운영",
            "컨설팅 관점 + 아키텍처 관점",
...
const app = {
    ...
    startQuiz: function() {
        ...
        // Prepare Questions
        const sourceData = this.currentType === '100' ? quizData100 : quizData200;
        // Randomly select 5
        this.questions = [...sourceData].sort(() => 0.5 - Math.random()).slice(0, 5);
    ...
    handleAnswer: function(selectedIndex) {
        ...
        if (selectedIndex === currentQ.correct) {
            this.score += 20; // 5 questions, 20 points each = 100
